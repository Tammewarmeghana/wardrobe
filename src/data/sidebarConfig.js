export const sidebarConfig = {
  traditional: [
    ...
    { label: "Croptops", path: "/traditional-croptops" },
    { label: "Kurthi Sets", path: "/kurthisets" },
  ...
  western: [
    ...
    { label: "Maxi Dresses", path: "/maxidress" },
    { label: "Croptops", path: "/western-croptops" },
  ...
  readymade: [
    ...
    { label: "Kurthis", path: "/readymade-item-2" },
    { label: "Peplum Tops", path: "/readymade-item-3" },
    { label: "Plazzo Tops", path: "/readymade-item-4" },
