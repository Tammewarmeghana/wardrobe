            ...
            <div className="page-container" style={{overflowX: 'hidden'}}>
                ...
                <div className="product-grid">
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", title: "Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>14,999</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269014/0475ecf856a31914a896bc3206c9ddb0-removebg-preview_yhxef0.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Mint Green Dress – Soft Wrap Wear</h3>
                            <p className="product-title">Mint green wrap dress with light flow and feminine styling.</p>
                    ...
                    {/* CARD 2 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Modern Indo-Western Fusion Saree with Attached Pallu", title: "Modern Indo-Western Fusion Saree with Attached Pallu", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>18,499</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269014/04c47e5316ca2a50fda3481b93e60da3-removebg-preview_xfa3a2.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Beige Floral Dress – Romantic Summer Wear</h3>
                            <p className="product-title">Beige floral dress with ruffles and soft elegant look.</p>
                    ...
                    {/* CARD 3 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Cocktail Saree Gown with Cape Sleeves", title: "Cocktail Saree Gown with Cape Sleeves", image: "", brand: "Western Elegance", price: <><span>₹</span>24,999</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269014/3c6845f85d85f4c00d2e1e83202e68f1-removebg-preview_dgyzxo.png"
                            alt="Modern Saree" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Olive Green Dress – Elegant Casual Wear</h3>
                            <p className="product-title">Olive green dress with layered hem and smooth movement.</p>
                    ...
                    {/* CARD 4 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Heritage Silk Trim Saree Gown for Wedding Receptions", title: "Heritage Silk Trim Saree Gown for Wedding Receptions", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269014/9a1b230f1b7d4644e08be37f58d0c8b7-removebg-preview_nhbq6v.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Soft Pink Dress – Feminine Wrap Wear</h3>
                            <p className="product-title">Soft pink wrap dress with airy graceful design.</p>
                    ...
                    {/* CARD 5 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Custom-Fit Sequined Saree Dress", title: "Custom-Fit Sequined Saree Dress", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>38,500</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269015/4a77ce961cb2689aa307727a90d6d2a2-removebg-preview_iv6vwa.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Grey Floral Dress – Relaxed Casual Wear</h3>
                            <p className="product-title">Grey floral dress with subtle prints and soft comfort.</p>
                    ...
                    {/* CARD 6 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Embroidered Pastel Saree Gown with Dupatta", title: "Embroidered Pastel Saree Gown with Dupatta", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>19,500</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269014/f8f016e988897aebd6e2a6ac77d81260-removebg-preview_z6fucv.png"
                            alt="Embroidered Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Wine Red Dress – Elegant Evening Wear</h3>
                            <p className="product-title">Wine red wrap dress with rich tones and refined style.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 7 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Olive Green Sequin Trim Saree", title: "Olive Green Sequin Trim Saree", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>16,200</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269015/ba2eb6ce9f7a0f7c563e2dbff689cb1a-removebg-preview_zw0pwk.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Ivory White Dress – Minimal Chic Wear</h3>
                            <p className="product-title">Ivory white dress with clean design and soft elegance.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 8 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Midnight Black Chiffon Saree Gown", title: "Midnight Black Chiffon Saree Gown", image: "", brand: "Western Elegance", price: <><span>₹</span>12,499</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269015/c75a6771539ea7313b74fbf89e5a965d-removebg-preview_omvpry.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Taupe Brown Dress – Neutral Stylish Wear</h3>
                            <p className="product-title">Taupe brown wrap dress with modern neutral styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 9 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Royal Navy Blue Designer Saree with Floral Appliques", title: "Royal Navy Blue Designer Saree with Floral Appliques", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>28,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269015/9762443fe1f41e8cc9464d4d26a7df66-removebg-preview_me6hdf.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Emerald Green Dress – Bold Elegant Wear</h3>
                            <p className="product-title">Emerald green dress with fitted waist and rich look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 10 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Nude Beige Premium Drape", title: "Nude Beige Premium Drape", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>36,100</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269033/9c38fd1b62fccfd93e6d0ad98ec78971-removebg-preview_ndsmmo.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">Plum Purple Dress – Evening Ready Wear</h3>
                            <p className="product-title">Plum purple dress with flowy layers and elegant feel.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 11 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Draped Georgette Saree Gown in Rose Pink", title: "Draped Georgette Saree Gown in Rose Pink", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269032/f1175262ab237c59c27dbfe25fd9643e-removebg-preview_rhjnn7.png"
                            alt="Saree Gown" className="card-image" style={{ backgroundColor: '#e5ccce' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#e5ccce' }}></div>
                            </div>
                            <h3 className="brand-name">White Black Dress – Modern Print Wear</h3>
                            <p className="product-title">White black dress with abstract prints and stylish design.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 12 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Pleated Indo-Western Saree with Matching Clutch", title: "Pleated Indo-Western Saree with Matching Clutch", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>12,500</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269032/236558bb4033c51e30fe1b7f4f45fd18-removebg-preview_lsouj0.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#a37272' }}></div>
                            </div>
                            <h3 className="brand-name">Sky Blue Dress – Fresh Casual Wear</h3>
                            <p className="product-title">Sky blue dress with airy silhouette and soft movement.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 13 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Minimalist Evening Gown Saree", title: "Minimalist Evening Gown Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269031/478456729a82cc90ef006db967e23b27-removebg-preview_egfld8.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Red Printed Dress – Vibrant Wrap Wear</h3>
                            <p className="product-title">Red printed wrap dress with bold feminine styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 14 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Handloom Silk Saree Gown for Receptions", title: "Handloom Silk Saree Gown for Receptions", image: "", brand: "Heritage Silks", price: <><span>₹</span>14,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269185/c1f69cb38a7482723e1a883358547eb1-removebg-preview_rforcv.png"
                            alt="Traditional Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#c93b4a' }}></div>
                            ...
                            <h3 className="brand-name">Beige Printed Dress – Minimal Elegant Wear</h3>
                            <p className="product-title">Beige printed dress with soft patterns and modern fit.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 15 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Signature Embellished Custom Saree", title: "Signature Embellished Custom Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>45,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269035/aaf167101ef64cd46e13b2861c36f157-removebg-preview_dm15xl.png"
                            alt="Bespoke Saree Gown" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">Maroon Sheer Dress – Rich Evening Wear</h3>
                            <p className="product-title">Maroon sheer dress with layered design and bold look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 16 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Peach Pastel Georgette Gown Saree", title: "Peach Pastel Georgette Gown Saree", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>13,300</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269034/7260194c870e8b67961174e867d9f265-removebg-preview_pv9c7h.png"
                            alt="Pastel Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Blush Pink Dress – Romantic Wrap Wear</h3>
                            <p className="product-title">Blush pink dress with soft flow and delicate styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                                <span className="rating-count">112</span>
                            </div>
                    ...
                    {/* CARD 17 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Festive Green Pre-Stitched Gown", title: "Festive Green Pre-Stitched Gown", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>15,400</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269034/db1756717f4b97317f7ed64e5598ba86-removebg-preview_wmhc2v.png"
                            alt="Festive Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#5d675b' }}></div>
                            </div>
                            <h3 className="brand-name">Coral Pink Dress – Playful Feminine Wear</h3>
                            <p className="product-title">Coral pink dress with ruffles and lively movement.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 18 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Classic Black Contemporary Wrap Saree", title: "Classic Black Contemporary Wrap Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269034/99698da177233bbd6dc316132d72cd3e-removebg-preview_hwutlc.png"
                            alt="Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">White Floral Dress – Breezy Summer Wear</h3>
                            <p className="product-title">White floral dress with delicate prints and light feel.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 19 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Rich Indigo Occasion Wear Layout Saree", title: "Rich Indigo Occasion Wear Layout Saree", image: "", brand: "Heritage Silks", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269442/026b57bc79e28d7d18987c2cde9eee45-removebg-preview_cwpg2t.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Lavender Purple Dress – Soft Elegant Wear</h3>
                            <p className="product-title">Lavender wrap dress with smooth flow and refined look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 20 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem8_Taupe High-Society Event Saree", title: "Taupe High-Society Event Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>30,800</> }} />
                        <img src="https://res.cloudinary.com/dugksxwkr/image/upload/v1777269463/2a7d321e51e4d965f3d8d5749f8e7479-removebg-preview_rtxavq.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            ...
                            <h3 className="brand-name">Peach Floral Dress – Light Feminine Wear</h3>
                            <p className="product-title">Peach floral dress with soft fabric and gentle styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
