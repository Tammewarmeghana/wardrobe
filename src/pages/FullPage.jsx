    ...
    return (
        <div className="fullpage-wrapper">
            ...
            <section className="features-strip">
                ...
                <div className="feature-item">
                    <svg viewBox="0 0 24 24"><path d="M21 4h-2V2h-2v2h-4V2H9v2H7V2H5v2H3v16h18V4zm-2 14H5V6h14v12zm-6-4h-2v2h2v-2zm0-4h-2v2h2V10z" /></svg>
                    <span>Costume Fitting</span>
                </div>
                <div className="feature-item">
                    <svg viewBox="0 0 24 24"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zm-8 7.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm6.5 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm-5-3.5h-5v-7h5v7zm4-4h2.5l1.96 2.5H17.5V8z" /></svg>
            ...
            <section className="bridal-sessions">
                ...
                <div className="bridal-text">
                    ...
                    <a href="#" className="btn-wipe">Book an Appointment</a>
                </div>
            </section>
                        ...
                        <div className="hidden-dress">
                            ...
                            <div className="product-overlay">
                                <div className="product-content">
                                    ...
                                    <p className="product-desc">Transform Your Wardrobe Upgrade your outfit without replacing it. Our color kit lets you change the color of your dress seamlessly—simple, effective, and affordable.</p>
                                    <button className="product-btn">Shop Now</button>
                                </div>
                            </div>
                        </div>
