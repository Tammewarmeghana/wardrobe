            ...
            <div className="page-container" style={{ overflowX: 'hidden' }}>
                ...
                <div className="product-grid">
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", title: "Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>14,999</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213269/k16-removebg-preview_ctq4mj.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Beige Red Print Kurti – Everyday Ethnic Wear</h3>
                            <p className="product-title">Beige kurti with red prints and simple traditional styling.</p>
                    ...
                    {/* CARD 2 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Modern Indo-Western Fusion Saree with Attached Pallu", title: "Modern Indo-Western Fusion Saree with Attached Pallu", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>18,499</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213270/k15-removebg-preview_jnhppd.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Mustard Yellow Top – Casual Modern Wear</h3>
                            <p className="product-title">Mustard yellow top with white prints and relaxed styling.</p>
                    ...
                    {/* CARD 3 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Cocktail Saree Gown with Cape Sleeves", title: "Cocktail Saree Gown with Cape Sleeves", image: "", brand: "Western Elegance", price: <><span>₹</span>24,999</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213270/k14-removebg-preview_rujmd5.png"
                            alt="Modern Saree" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Red Printed Kurti – Vibrant Daily Wear</h3>
                            <p className="product-title">Red kurti with prints and comfortable relaxed fit.</p>
                    ...
                    {/* CARD 4 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Heritage Silk Trim Saree Gown for Wedding Receptions", title: "Heritage Silk Trim Saree Gown for Wedding Receptions", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213270/k13-removebg-preview_kd7ari.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Pink Floral Dress – Summer Casual Wear</h3>
                            <p className="product-title">Pink floral dress with sleeveless design and fresh styling.</p>
                    ...
                    {/* CARD 5 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Custom-Fit Sequined Saree Dress", title: "Custom-Fit Sequined Saree Dress", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>38,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k9-removebg-preview_qjsdww.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Maroon Black Dress – Traditional Elegant Wear</h3>
                            <p className="product-title">Maroon black dress with ethnic patterns and refined look.</p>
                    ...
                    {/* CARD 6 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Embroidered Pastel Saree Gown with Dupatta", title: "Embroidered Pastel Saree Gown with Dupatta", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>19,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k11-removebg-preview_qagzoy.png"
                            alt="Embroidered Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Teal Green Suit – Subtle Festive Wear</h3>
                            <p className="product-title">Teal green suit with dupatta and soft ethnic charm.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 7 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Olive Green Sequin Trim Saree", title: "Olive Green Sequin Trim Saree", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>16,200</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k10-removebg-preview_er4py5.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Beige Gold Dress – Classic Ethnic Wear</h3>
                            <p className="product-title">Beige gold dress with prints and traditional elegance.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 8 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Midnight Black Chiffon Saree Gown", title: "Midnight Black Chiffon Saree Gown", image: "", brand: "Western Elegance", price: <><span>₹</span>12,499</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k8-removebg-preview_lwzyar.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Navy Blue Dress – Evening Ethnic Wear</h3>
                            <p className="product-title">Navy blue dress with shimmer and stylish finish.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 9 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Royal Navy Blue Designer Saree with Floral Appliques", title: "Royal Navy Blue Designer Saree with Floral Appliques", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>28,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k6-removebg-preview_xlmvbc.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Royal Blue Jumpsuit – Modern Statement Wear</h3>
                            <p className="product-title">Royal blue jumpsuit with bold design and contemporary look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 10 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Nude Beige Premium Drape", title: "Nude Beige Premium Drape", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>36,100</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213271/k12-removebg-preview_lsfuhz.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">Beige Pink Top – Soft Casual Wear</h3>
                            <p className="product-title">Beige top with pink prints and feminine styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 11 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Draped Georgette Saree Gown in Rose Pink", title: "Draped Georgette Saree Gown in Rose Pink", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213272/k7-removebg-preview_x0gexg.png"
                            alt="Saree Gown" className="card-image" style={{ backgroundColor: '#e5ccce' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#e5ccce' }}></div>
                            </div>
                            <h3 className="brand-name">Light Blue Saree Set – Minimal Elegant Wear</h3>
                            <p className="product-title">Light blue saree set with soft drape and clean design.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 12 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Pleated Indo-Western Saree with Matching Clutch", title: "Pleated Indo-Western Saree with Matching Clutch", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>12,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213273/k5-removebg-preview_aenq98.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#a37272' }}></div>
                            </div>
                            <h3 className="brand-name">Pink Ethnic Dress – Modern Traditional Wear</h3>
                            <p className="product-title">Pink ethnic dress with fitted silhouette and classic patterns.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 13 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Minimalist Evening Gown Saree", title: "Minimalist Evening Gown Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213276/3374395ea1d1fefe2363d693393f99c8-removebg-preview_fnpvgd.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Bright Pink Suit – Festive Ethnic Wear</h3>
                            <p className="product-title">Bright pink suit with sheer layers and vibrant styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 14 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Handloom Silk Saree Gown for Receptions", title: "Handloom Silk Saree Gown for Receptions", image: "", brand: "Heritage Silks", price: <><span>₹</span>14,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213276/6dcd5e378bfa908ce4a5b34c9a0e555c-removebg-preview_uzhs3u.png"
                            alt="Traditional Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#c93b4a' }}></div>
                            ...
                            <h3 className="brand-name">Red Beige Suit – Classic Ethnic Wear</h3>
                            <p className="product-title">Red beige suit with rich patterns and traditional appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 15 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Signature Embellished Custom Saree", title: "Signature Embellished Custom Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>45,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213276/08c5399b225ceca607402b2a1b2916ab-removebg-preview_u4hrjl.png"
                            alt="Bespoke Saree Gown" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">White Blue Suit – Fresh Elegant Wear</h3>
                            <p className="product-title">White suit with blue floral dupatta and soft styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 16 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Peach Pastel Georgette Gown Saree", title: "Peach Pastel Georgette Gown Saree", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>13,300</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213277/0872b69163b44a669d28d935c248cd80-removebg-preview_eocubd.png"
                            alt="Pastel Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Multicolor Kurti – Playful Ethnic Wear</h3>
                            <p className="product-title">Multicolor kurti with vibrant patterns and casual look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                                <span className="rating-count">112</span>
                            </div>
                    ...
                    {/* CARD 17 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Festive Green Pre-Stitched Gown", title: "Festive Green Pre-Stitched Gown", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>15,400</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213275/k1-removebg-preview_wdlgj6.png"
                            alt="Festive Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#5d675b' }}></div>
                            </div>
                            <h3 className="brand-name">Blue Printed Top – Everyday Casual Wear</h3>
                            <p className="product-title">Blue printed top with relaxed fit and modern styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 18 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Classic Black Contemporary Wrap Saree", title: "Classic Black Contemporary Wrap Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213275/k3-removebg-preview_kzevpb.png"
                            alt="Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Brown Printed Top – Earthy Casual Wear</h3>
                            <p className="product-title">Brown printed top with comfortable everyday design.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 19 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Rich Indigo Occasion Wear Layout Saree", title: "Rich Indigo Occasion Wear Layout Saree", image: "", brand: "Heritage Silks", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213273/k4-removebg-preview_bncikl.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Black Printed Dress – Minimal Elegant Wear</h3>
                            <p className="product-title">Black printed dress with sleek silhouette and subtle charm.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 20 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem2_Taupe High-Society Event Saree", title: "Taupe High-Society Event Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>30,800</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777213274/k2-removebg-preview_g25lya.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            ...
                            <h3 className="brand-name">Dark Blue Printed Top – Modern Casual Wear</h3>
                            <p className="product-title">Dark blue printed top with structured fit and bold appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
