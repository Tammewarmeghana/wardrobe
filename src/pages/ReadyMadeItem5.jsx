            ...
            <div className="page-container" style={{overflowX: 'hidden'}}>
                ...
                <div className="product-grid">
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", title: "Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>14,999</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263824/65fce8adb6db5c050f94ef6983488280-removebg-preview_ludflo.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">White Flowing Skirt – Soft Elegant Wear</h3>
                            <p className="product-title">White skirt with layered flow and graceful feminine movement.</p>
                    ...
                    {/* CARD 2 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Modern Indo-Western Fusion Saree with Attached Pallu", title: "Modern Indo-Western Fusion Saree with Attached Pallu", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>18,499</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263824/dfbe5e123a049c6bd7db9e5f51fc8903-removebg-preview_dix5f4.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Floral Midi Skirt – Breezy Casual Wear</h3>
                            <p className="product-title">Floral midi skirt with pastel tones and light styling.</p>
                    ...
                    {/* CARD 3 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Cocktail Saree Gown with Cape Sleeves", title: "Cocktail Saree Gown with Cape Sleeves", image: "", brand: "Western Elegance", price: <><span>₹</span>24,999</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263771/75361a93a35513165b76c3c489dcc8a2-removebg-preview_p31dwx.png"
                            alt="Modern Saree" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">White Tiered Skirt – Feminine Volume Wear</h3>
                            <p className="product-title">White tiered skirt with soft layers and elegant shape.</p>
                    ...
                    {/* CARD 4 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Heritage Silk Trim Saree Gown for Wedding Receptions", title: "Heritage Silk Trim Saree Gown for Wedding Receptions", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263771/ded26de72d1b99ef15ac3f5e26b9fc19-removebg-preview_zx0e7d.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Blue Floral Skirt – Summer Casual Wear</h3>
                            <p className="product-title">Blue floral skirt with ruffles and vibrant styling.</p>
                    ...
                    {/* CARD 5 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Custom-Fit Sequined Saree Dress", title: "Custom-Fit Sequined Saree Dress", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>38,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263771/65149185cde1eef7032b7ca512783a6a-removebg-preview_o9p9kf.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Beige Printed Skirt – Soft Romantic Wear</h3>
                            <p className="product-title">Beige printed skirt with subtle patterns and gentle flow.</p>
                    ...
                    {/* CARD 6 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Embroidered Pastel Saree Gown with Dupatta", title: "Embroidered Pastel Saree Gown with Dupatta", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>19,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263771/c4fc7c1c6a5ca609614396ca07dc0638-removebg-preview_mfyhth.png"
                            alt="Embroidered Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Cream Pleated Skirt – Minimal Chic Wear</h3>
                            <p className="product-title">Cream pleated skirt with buttons and refined styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 7 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Olive Green Sequin Trim Saree", title: "Olive Green Sequin Trim Saree", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>16,200</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263770/fd5c223fe10f282d1880b2728957a8b6-removebg-preview_ssj9cr.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Rust Orange Skirt – Bohemian Statement Wear</h3>
                            <p className="product-title">Rust orange skirt with layered design and bold look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 8 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Midnight Black Chiffon Saree Gown", title: "Midnight Black Chiffon Saree Gown", image: "", brand: "Western Elegance", price: <><span>₹</span>12,499</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263754/a3612bc9d3fa4167e1d8f900df6c3d17-removebg-preview_vqyeoi.png"
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Teal Printed Skirt – Ethnic Casual Wear</h3>
                            <p className="product-title">Teal skirt with prints and flowing silhouette.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 9 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Royal Navy Blue Designer Saree with Floral Appliques", title: "Royal Navy Blue Designer Saree with Floral Appliques", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>28,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263718/a516a41af77fa835f68a371a4f4bbe7d-removebg-preview_boseab.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Olive Green Skirt – Casual Elegant Wear</h3>
                            <p className="product-title">Olive green skirt with gathered waist and soft styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 10 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Nude Beige Premium Drape", title: "Nude Beige Premium Drape", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>36,100</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263736/bf84bcdb8386dc5c8e749f2f4658d47b-removebg-preview_odl65i.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">Dusty Pink Skirt – Feminine Soft Wear</h3>
                            <p className="product-title">Dusty pink skirt with layered design and gentle flow.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 11 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Draped Georgette Saree Gown in Rose Pink", title: "Draped Georgette Saree Gown in Rose Pink", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263703/a905b735351db0345523c8b828831203-removebg-preview_kpkoq3.png"
                            alt="Saree Gown" className="card-image" style={{ backgroundColor: '#e5ccce' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#e5ccce' }}></div>
                            </div>
                            <h3 className="brand-name">Beige Lace Skirt – Delicate Elegant Wear</h3>
                            <p className="product-title">Beige lace skirt with intricate texture and refined look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 12 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Pleated Indo-Western Saree with Matching Clutch", title: "Pleated Indo-Western Saree with Matching Clutch", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>12,500</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263703/1e0836661c63e3214fdbff71d20a476a-removebg-preview_nmtjxi.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#a37272' }}></div>
                            </div>
                            <h3 className="brand-name">Coral Pleated Skirt – Playful Casual Wear</h3>
                            <p className="product-title">Coral pleated skirt with gradient tones and movement.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 13 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Minimalist Evening Gown Saree", title: "Minimalist Evening Gown Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263703/f535f843f2e93f615fec063aa0c86fc9-removebg-preview_goh8ly.png"
                            alt="Saree Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Mustard Yellow Skirt – Vibrant Casual Wear</h3>
                            <p className="product-title">Mustard skirt with flowy design and bright styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 14 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Handloom Silk Saree Gown for Receptions", title: "Handloom Silk Saree Gown for Receptions", image: "", brand: "Heritage Silks", price: <><span>₹</span>14,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/c0ec223fa8502a10a80761b5437b1010-removebg-preview_s6wrmu.png"
                            alt="Traditional Saree Gown" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#c93b4a' }}></div>
                            ...
                            <h3 className="brand-name">Black Printed Skirt – Traditional Style Wear</h3>
                            <p className="product-title">Black printed skirt with ethnic patterns and rich look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 15 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Signature Embellished Custom Saree", title: "Signature Embellished Custom Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>45,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/1cb6261baeccede3f32f1a5d3a529f45-removebg-preview_bppahh.png"
                            alt="Bespoke Saree Gown" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            </div>
                            <h3 className="brand-name">Gold Flared Skirt – Luxe Festive Wear</h3>
                            <p className="product-title">Gold flared skirt with shimmer and elegant styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 16 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Peach Pastel Georgette Gown Saree", title: "Peach Pastel Georgette Gown Saree", image: "", brand: "Maison d'Élégance", price: <><span>₹</span>13,300</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/bf2791780a5061488bc3ec22c44821dd-removebg-preview_ubyd26.png"
                            alt="Pastel Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#bb9b9f' }}></div>
                            </div>
                            <h3 className="brand-name">Brown Tiered Skirt – Earthy Elegant Wear</h3>
                            <p className="product-title">Brown tiered skirt with textured layers and soft look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                                <span className="rating-count">112</span>
                            </div>
                    ...
                    {/* CARD 17 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Festive Green Pre-Stitched Gown", title: "Festive Green Pre-Stitched Gown", image: "", brand: "Queen's Wardrobe", price: <><span>₹</span>15,400</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/967f7ece60ff0a1e9731c100dd563015-removebg-preview_onnl03.png"
                            alt="Festive Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#5d675b' }}></div>
                            </div>
                            <h3 className="brand-name">Orange Flared Skirt – Festive Traditional Wear</h3>
                            <p className="product-title">Orange flared skirt with bold tone and festive appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 18 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Classic Black Contemporary Wrap Saree", title: "Classic Black Contemporary Wrap Saree", image: "", brand: "Western Elegance", price: <><span>₹</span>18,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/06e8f99833b064137bd6530b798b18f2-removebg-preview_ydasna.png"
                            alt="Gown" className="card-image" />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#2F2A26' }}></div>
                            </div>
                            <h3 className="brand-name">Black Gold Skirt – Royal Ethnic Wear</h3>
                            <p className="product-title">Black gold skirt with intricate motifs and rich styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                    ...
                    {/* CARD 19 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Rich Indigo Occasion Wear Layout Saree", title: "Rich Indigo Occasion Wear Layout Saree", image: "", brand: "Heritage Silks", price: <><span>₹</span>21,000</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263702/8ed47341a428f56d8f85cebd5d71cb76-removebg-preview_dttcui.png"
                            alt="Royal Saree" className="card-image" style={{ backgroundColor: '#fceceb' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#0b2b4e' }}></div>
                            </div>
                            <h3 className="brand-name">Navy Blue Skirt – Structured Modern Wear</h3>
                            <p className="product-title">Navy skirt with pleats and refined silhouette.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                    ...
                    {/* CARD 20 */}
                    <div className="product-card" style={{ position: "relative" }}>
                        <WishlistHeart item={{ id: "ReadyMadeItem5_Taupe High-Society Event Saree", title: "Taupe High-Society Event Saree", image: "", brand: "Queen's Bespoke", price: <><span>₹</span>30,800</> }} />
                        <img src="https://res.cloudinary.com/dodmxncwc/image/upload/v1777263703/f5cc255e1bb7750df96fcb15a266148d-removebg-preview_pc2wfz.png"
                            alt="Premium Drape" className="card-image" style={{ backgroundColor: '#e5e0dc' }} />
                        <div className="card-content">
                            <div className="swatches">
                                <div className="swatch" style={{ backgroundColor: '#d1bfae' }}></div>
                            ...
                            <h3 className="brand-name">Lavender Printed Skirt – Soft Feminine Wear</h3>
                            <p className="product-title">Lavender skirt with prints and gentle flowing design.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
