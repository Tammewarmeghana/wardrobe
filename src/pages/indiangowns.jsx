                ...
                <div className="product-grid">
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Rust Brown Gown – Elegant Evening Wear</h3>
                            <p className="product-title">Rust brown gown with shimmer fabric and graceful silhouette.</p>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_706cb092", name: "Premium Pre-Draped Saree Gown in Soft Georgette with Embellished Belt", price: 14999, image: "", color: "#e5ccce", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Bright Pink Gown – Vibrant Festive Wear</h3>
                            <p className="product-title">Bright pink gown with flowy layers and lively styling.</p>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_fd128a9d", name: "Modern Indo-Western Fusion Saree with Attached Pallu", price: 18499, image: "", color: "#a37272", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Sage Green Gown – Soft Ethnic Wear</h3>
                            <p className="product-title">Sage green gown with dupatta and graceful flow.</p>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_9a533f20", name: "Cocktail Saree Gown with Cape Sleeves", price: 24999, image: "", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Peach Ombre Gown – Feminine Elegant Wear</h3>
                            <p className="product-title">Peach ombre gown with gradient tones and soft design.</p>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_4aa57ea8", name: "Heritage Silk Trim Saree Gown for Wedding Receptions", price: 21000, image: "", color: "#c93b4a", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Emerald Green Gown – Regal Festive Wear</h3>
                            <p className="product-title">Emerald green gown with rich fabric and royal presence.</p>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_8f70a15a", name: "Custom-Fit Sequined Saree Dress", price: 38500, image: "", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Blue Ombre Gown – Modern Elegant Wear</h3>
                            <p className="product-title">Blue ombre gown with gradient effect and smooth silhouette.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_d2479aa3", name: "Embroidered Pastel Saree Gown with Dupatta", price: 19500, image: "", color: "#bb9b9f", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Hot Pink Gown – Bold Festive Wear</h3>
                            <p className="product-title">Hot pink gown with dupatta and vibrant styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_87b31d82", name: "Olive Green Sequin Trim Saree", price: 16200, image: "", color: "#5d675b", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Deep Red Gown – Traditional Evening Wear</h3>
                            <p className="product-title">Deep red gown with embroidered hem and rich appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_04ab1340", name: "Midnight Black Chiffon Saree Gown", price: 12499, image: "", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Peach Embroidered Gown – Bridal Elegant Wear</h3>
                            <p className="product-title">Peach gown with heavy embroidery and soft festive look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_243db46b", name: "Royal Navy Blue Designer Saree with Floral Appliques", price: 28000, image: "", color: "#0b2b4e", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Lavender Gown – Dreamy Elegant Wear</h3>
                            <p className="product-title">Lavender gown with shimmer detailing and graceful flow.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_82ca3f16", name: "Nude Beige Premium Drape", price: 36100, image: "", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Olive Green Gown – Minimal Ethnic Wear</h3>
                            <p className="product-title">Olive green gown with subtle movement and soft styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_789d0858", name: "Draped Georgette Saree Gown in Rose Pink", price: 18000, image: "", color: "#e5ccce", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Taupe Grey Gown – Modern Evening Wear</h3>
                            <p className="product-title">Taupe grey gown with shimmer texture and sleek silhouette.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_514e3d7b", name: "Pleated Indo-Western Saree with Matching Clutch", price: 12500, image: "", color: "#a37272", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Blush Pink Gown – Romantic Wear</h3>
                            <p className="product-title">Blush pink gown with floral embroidery and soft elegance.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_6a99bb6b", name: "Minimalist Evening Gown Saree", price: 21000, image: "", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Plum Purple Gown – Rich Festive Wear</h3>
                            <p className="product-title">Plum purple gown with intricate detailing and bold styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_afe609b2", name: "Handloom Silk Saree Gown for Receptions", price: 14000, image: "", color: "#c93b4a", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Golden Beige Gown – Classic Luxe Wear</h3>
                            <p className="product-title">Golden beige gown with embroidery and rich traditional appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_c689a5fc", name: "Signature Embellished Custom Saree", price: 45000, image: "", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Dark Green Gown – Elegant Formal Wear</h3>
                            <p className="product-title">Dark green gown with structured bodice and flared skirt.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                                <span className="rating-count">112</span>
                            </div>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_6080f25e", name: "Peach Pastel Georgette Gown Saree", price: 13300, image: "", color: "#bb9b9f", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Black Floral Gown – Statement Wear</h3>
                            <p className="product-title">Black floral gown with bold prints and stylish look.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_6917cdce", name: "Festive Green Pre-Stitched Gown", price: 15400, image: "", color: "#5d675b", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Teal Blue Gown – Graceful Ethnic Wear</h3>
                            <p className="product-title">Teal blue gown with pleats and soft flowing silhouette.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★☆</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_513e345c", name: "Classic Black Contemporary Wrap Saree", price: 18000, image: "", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Red Evening Gown – Timeless Elegant Wear</h3>
                            <p className="product-title">Red gown with sleek design and classic appeal.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_63e7ad91", name: "Rich Indigo Occasion Wear Layout Saree", price: 21000, image: "", color: "#0b2b4e", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <h3 className="brand-name">Wine Maroon Gown – Dramatic Festive Wear</h3>
                            <p className="product-title">Wine maroon gown with embellished bodice and rich styling.</p>
                            <div className="rating-block">
                                <span className="stars">★★★★★</span>
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_0effac85", name: "Taupe High-Society Event Saree", price: 30800, image: "", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
