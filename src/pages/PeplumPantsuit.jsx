                ...
                <div className="product-grid">
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_6fa7e861", name: "Modern Indo-Western Fusion Saree with Attached Pallu", price: 18499, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069651/p2-removebg-preview_b1nyph.png", color: "#a37272", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_904f4869", name: "Cocktail Saree Gown with Cape Sleeves", price: 24999, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069661/p3-removebg-preview_uqeuu0.png", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_1b603ff7", name: "Heritage Silk Trim Saree Gown for Wedding Receptions", price: 21000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069669/p4-removebg-preview_hnhaih.png", color: "#c93b4a", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_4bd99bf6", name: "Custom-Fit Sequined Saree Dress", price: 38500, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069728/p5-removebg-preview_wgc53q.png", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_69b3aa4d", name: "Embroidered Pastel Saree Gown with Dupatta", price: 19500, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069737/p6-removebg-preview_bsvx7z.png", color: "#bb9b9f", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_636c9f92", name: "Olive Green Sequin Trim Saree", price: 16200, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069766/p7-removebg-preview_dlfhlh.png", color: "#5d675b", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_6526e675", name: "Midnight Black Chiffon Saree Gown", price: 12499, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069775/p8-removebg-preview_x5gdql.png", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_412352d5", name: "Royal Navy Blue Designer Saree with Floral Appliques", price: 28000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069794/p10-removebg-preview_fcvwxu.png", color: "#0b2b4e", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_fa8e828b", name: "Nude Beige Premium Drape", price: 36100, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069802/p11-removebg-preview_fs4c9x.png", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_4c089c7d", name: "Draped Georgette Saree Gown in Rose Pink", price: 18000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069785/p9-removebg-preview_dhlogm.png", color: "#e5ccce", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_81851150", name: "Pleated Indo-Western Saree with Matching Clutch", price: 12500, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069837/p14-removebg-preview_alhi8c.png", color: "#a37272", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_d5d6956b", name: "Minimalist Evening Gown Saree", price: 21000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069837/p14-removebg-preview_alhi8c.png", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_3be44715", name: "Handloom Silk Saree Gown for Receptions", price: 14000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069827/p13-removebg-preview_vztgux.png", color: "#c93b4a", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_b735d2c4", name: "Signature Embellished Custom Saree", price: 45000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069816/p12-removebg-preview_sfnd9d.png", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_162e7c09", name: "Peach Pastel Georgette Gown Saree", price: 13300, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069856/p16-removebg-preview_v6wxfa.png", color: "#bb9b9f", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_4faac41d", name: "Festive Green Pre-Stitched Gown", price: 15400, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069865/p17-removebg-preview_ey8bf4.png", color: "#5d675b", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_b0f8fca7", name: "Classic Black Contemporary Wrap Saree", price: 18000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069893/p20-removebg-preview_t8kthr.png", color: "#2F2A26", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_eb0abfac", name: "Rich Indigo Occasion Wear Layout Saree", price: 21000, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069873/p18-removebg-preview_c1zhbi.png", color: "#0b2b4e", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="product-card" style={{ position: "relative" }}>
                        ...
                        <div className="card-content">
                            ...
                            <button className="buying-options-btn" onClick={() => handleAddToCart({ id: "prod_aa9cb33e", name: "Taupe High-Society Event Saree", price: 30800, image: "https://res.cloudinary.com/dugksxwkr/image/upload/v1776069883/p19-removebg-preview_ktwr2n.png", color: "#d1bfae", size: "Free Size" })}>Add to Cart</button>
                        </div>
                    </div>
